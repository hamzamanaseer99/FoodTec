...
//             left: 0,
//             right: 0,
//             child: _buildBottomSheet(context, isDarkMode), // تمرير الوضع الداكن
//           ),
//         ],
//       ),
//     );
...
class LiveTrackScreen extends StatefulWidget {
  ...
  @override
  State<LiveTrackScreen> createState() => _SearchPageState();
}

class _SearchPageState extends State<LiveTrackScreen> {
  LatLng? selectedLocation;
  String selectedAddressTitle = 'Loading...';
  final Set<Marker> markers = {};

  void updateSelectedLocation(LatLng latLng, String addressTitle) {
    setState(() {
      ...
      markers.add(
        Marker(
          ...
          position: latLng,
          infoWindow: InfoWindow(title: addressTitle),
        ),
      );
    });
  }
        ...
        children: [
          GoogleMap(
            initialCameraPosition: const CameraPosition(
              target: LatLng(31.963158, 35.930359), // الموقع الابتدائي: عمّان
              zoom: 14.0,
            ),
            markers: markers,
            onTap: (latLng) {
              // تحديث العنوان بناءً على النقر - هنا تحتاج تضيف دالة للحصول على العنوان من latLng
              updateSelectedLocation(latLng, 'تم اختيار الموقع');
            },
          ),
          Positioned(
            bottom: 20,
            ...
            child: Row(
              ...
              children: [
                _buildIconButton(Icons.my_location, const Color(0xffF2AB58)),
                _buildIconButton(Icons.chat, const Color(0xffF2AB58)),
              ],
            ),
          ),
  ...
  Widget _buildIconButton(IconData icon, Color color) {
    return Container(
      ...
      child: IconButton(
        ...
        onPressed: () {
          // أضف الأكشن هنا لكل زر
          print('Button $icon pressed');
        },
      ),
    );
  }
