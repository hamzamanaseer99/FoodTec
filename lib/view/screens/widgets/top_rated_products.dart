...
//                 itemBuilder: (context, index) {
//                   final product = state.products[index];
//                   return _buildProductCard(screenWidth, product, isDark);
//                 },
//               );
//             }
//             return Center(child: CircularProgressIndicator());
...
//   }
//
//   Widget _buildProductCard(double screenWidth, Map<String, dynamic> product, bool isDark) {
//     return SizedBox(
//       width: 170,
//       child: Card(
...
//             _buildProductImage(product),
//             _buildProductDetails(screenWidth, product, isDark),
//           ],
//         ),
//       ),
//     );
...
//         IconButton(
//           onPressed: () {
//             // الحصول على المنتج الذي تريد إضافته (افترض أن لديك الـ product)
...
//                 itemBuilder: (context, index) {
//                   final product = state.products[index];
//                   return _buildProductCard(screenWidth, product, isDark, context); // Pass context to card
//                 },
//               );
//             }
//             return Center(child: CircularProgressIndicator());
...
//           Text(
//             product["description"],
//             maxLines: 2, // or any number of lines you want
...
//                 ),
//               ),
//               _buildAddButton(screenWidth, context), // Pass context to add button
//             ],
//           ),
//         ],
//       ),
...
//   }
//
//   Widget _buildAddButton(double screenWidth, BuildContext context) {
//     return Container(
//       width: 30,
//       height: 30,
//       decoration: const BoxDecoration(
...
//         child: IconButton(
//           onPressed: () {
//             // Assuming you already have a product model and data
//             final product = Product(
//               name: 'Product Name',
//               price: 20.0,
//               image: '',
...
//             );
//
//             // Make sure CartCubit is available in the context
//             // Passing default values for spicyLevel and quantity
//             context.read<CartCubit>().addToCart(
//               product: product,
//               spicyLevel: 1.0,  // Use a default spicy level, for example 1.0
