          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildSectionTitle(context, 'Discount'),
                SizedBox(height: responsiveHeight(context, 24)),
                Row(
                  children: [
                    minMaxContainer(context, 'Min'),
                ...
                SizedBox(height: responsiveHeight(context, 32)),
                _buildSectionTitle(context, 'Dish'),
                SizedBox(height: responsiveHeight(context, 24)),
    ...
    return Row(
      children: [
        SelectableCard(
          title: 'Fast Food',
          isSelected: selectedCategory == 'Fast Food',
          onTap: () => setState(() => selectedCategory = 'Fast Food'),
        ),
        SizedBox(width: responsiveWidth(context, 10)),
        SelectableCard(
          title: 'Sea Food',
          isSelected: selectedCategory == 'Sea Food',
          onTap: () => setState(() => selectedCategory = 'Sea Food'),
        ),
        SizedBox(width: responsiveWidth(context, 10)),
        SelectableCard(
          title: 'Dessert',
          isSelected: selectedCategory == 'Dessert',
          onTap: () => setState(() => selectedCategory = 'Dessert'),
        ),
      ],
    );
  }
    ...
    return Row(
      children: [
        SelectableCard(
          title: '1 KM',
          isSelected: selected1Category == '1 KM',
          onTap: () => setState(() => selected1Category = '1 KM'),
        ),
        SizedBox(width: responsiveWidth(context, 10)),
        SelectableCard(
          title: '5 KM',
          isSelected: selected1Category == '5 KM',
          onTap: () => setState(() => selected1Category = '5 KM'),
        ),
        SizedBox(width: responsiveWidth(context, 10)),
        SelectableCard(
          title: '10 KM',
          isSelected: selected1Category == '10 KM',
          onTap: () => setState(() => selected1Category = '10 KM'),
        ),
      ],
    );
  }
