              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Turn On Your Location',
                      style:
                          TextStyle(fontSize: 32, fontWeight: FontWeight.w500,color: Color(0xFF455A64))),
                  SizedBox(height: 10),
                  Text(
                      'To Continues, Let Your Device Turn On Location, Which Uses Google’s Location Service',
                      textAlign: TextAlign.center,style: TextStyle(fontSize: 16, fontWeight: FontWeight.w400,color: Color(0xFF455A64))),
                  SizedBox(height: 10),
                  ElevatedButton(
                    onPressed: () {
